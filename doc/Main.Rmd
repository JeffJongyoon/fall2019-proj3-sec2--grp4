...
```{r}
#Nicole's updates: changed train.R to return gbm model, and test.R to test the predictions
#model done with no cross validation yet
source("../lib/train.R")
load(file="../output/feature_train.RData")

#now actually train
tm_train=NA
tm_train <- system.time(fit_train <- train(dat_train, NULL))
save(fit_train, file="../output/fit_train.RData")

```

```{r}
#Test the baseline model and evaluate: random guess is 4.6
